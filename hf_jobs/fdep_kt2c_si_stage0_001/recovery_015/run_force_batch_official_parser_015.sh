...
WORK="${1:-/tmp/fdep_kt2c_force_recovery_015}"
...
if max_abs <= 1e-5:
    raise SystemExit(f'FORCE_SCALE_SANITY_FAIL {prefix} max_abs={max_abs}')
receipt={
  ...
  'reported_total_force_Ry_per_Bohr':float(totals[-1]) if totals else None,
...
result={
 'document_code':'FDEP_KT2C_SI_FORCE_BATCH_OFFICIAL_PARSER_015',
 ...
 'gates':{'KT2C_G14A_OFFICIAL_QE_FORCE_EXTRACTION':'PASS'},
