...
final = {"status": status, "resolved_revision": revision, "prompts_completed": len(PROMPTS),
         ...
         "compact_bundle_sha256": sha256_file(compact_zip), "private_dataset_repo": None, "stage_c_executed": False}
...
if token:
    try:
        ...
        print("STAGE_AB_PRIVATE_DATASET=" + OUTPUT_REPO, flush=True)
    except Exception as exc:
        print("STAGE_AB_PERSISTENCE_WARNING=" + repr(exc), flush=True)
else:
    print("STAGE_AB_PERSISTENCE_WARNING=HF_TOKEN missing", flush=True)
