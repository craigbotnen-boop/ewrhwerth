...
Consider a drug molecule diffusing near the horizon. The probability flux $J$ is biased towards the region of higher spectral dimension. We define the rectification ratio $R_{\text{rect}} = J_{\text{out}}/J_{\text{in}}$, and observe $R_{\text{rect}} \gtrsim 10^{6}$ in simulations, consistent with an effectively one-way topological valve at the Malignancy Horizon. This confirms that the rim functions as a topological diode, sequestering therapeutic agents away from the core.
